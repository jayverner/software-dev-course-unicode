...
*/
let inputString = "Hi"
let valueZero = inputString.charCodeAt(0);
let valueOne = inputString.charCodeAt(1);
let sumCodePoints = valueZero + valueOne;
...
let combinedString = String.fromCharCode(codePoint1, codePoint2);
...
let codePointDifference = inputString.charCodeAt(index1) - inputString.charCodeAt(index2);
...
let arrayOfCodePoints = [74, 97, 118, 97, 83, 99, 114, 105, 112, 116];
let wordFromCodePoints = String.fromCharCode(arrayOfCodePoints);
/*
...
let swappedString = lastChar + middlePart + firstChar;
